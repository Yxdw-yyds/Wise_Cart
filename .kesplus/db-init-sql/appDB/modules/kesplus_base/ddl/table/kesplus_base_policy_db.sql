-- "kesplus_base"."kesplus_base_policy_db" definition
...
CREATE TABLE "kesplus_base"."kesplus_base_policy_db" (
	...
	"create_policy" text  NULL,
	"drop_policy" text  NULL,
...
COMMENT ON COLUMN "kesplus_base"."kesplus_base_policy_db"."tenant_id" IS '租户id';

CREATE INDEX idx_kesplus_base_policy_db_policy ON kesplus_base.kesplus_base_policy_db(policy_id);
