/*CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_userrole" AS
-- 用户与角色关联
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_urole" AS
--用户与用户角色
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_user_restful" AS
--用户与restful
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_policy" AS
--数据权限
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_role" AS
--角色
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_user_permission" AS
--用户与权限点
WITH RECURSIVE t AS (
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_restful" AS
--restful
SELECT sa.id,
    sa.code,
    sa.path,
...
UNION
 SELECT sa.id,
   ...
   --用户、部门、
CREATE MATERIALIZED VIEW IF NOT EXISTS "kesplus_base"."kesplus_mv_user_info" AS
...
kud."default_flag", kud."login_flag", kud."enabled" AS "enabled2"
FROM "kesplus_base"."kesplus_user" ku
