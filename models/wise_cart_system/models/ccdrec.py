...
class ccdrec(GeneralRecommender):
    def __init__(self, config, dataset):
        ...
        self.interaction_matrix_dense = torch.tensor(
            self.interaction_matrix_csr.todense(),
            device=self.device,
        )
...
#             ipdb.set_trace()
    ...
    def get_norm_adj_mat(self):
        ...
        # Use public sparse assignment APIs for SciPy compatibility.
        A[inter_M.row, inter_M.col + self.n_users] = 1
        A[inter_M_t.row + self.n_users, inter_M_t.col] = 1
        # norm adj matrix
